...
#------------------------------
    ...
    # 2 degree, 40', 10', 2', 15", 1/3"
    amrdata.refinement_ratios_x = [3,4,5,8,45]
    amrdata.refinement_ratios_y = [3,4,5,8,45]
    amrdata.refinement_ratios_t = [3,4,5,8,45]
