...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times =  np.append(np.linspace(7.5,9,19), \
                np.linspace(10,13,4)) * 3600.
    ...
    gauges.append([1107, 202.12623, 21.29147, 7.0*3600., 1.e9]) #HAI1107 
    gauges.append([1, 202.1035, 21.302, 7.0*3600., 1.e9]) # channel
    gauges.append([2, 202.128, 21.293, 7.0*3600., 1.e9]) # channel

    # Tide gauge:
    gauges.append([12340, 202.1333333, 21.30666667, 7.0*3600., 1.e9])

    # Kilo Nalu
    gauges.append([5, 202.135, 21.288, 7.0*3600., 1.e9])
    ...
    # 2 degree, 24', 4', 1', 6", 2/3"
    amrdata.refinement_ratios_x = [5, 6, 4, 10, 9]
    amrdata.refinement_ratios_y = [5, 6, 4, 10, 9]
    amrdata.refinement_ratios_t = [5, 6, 4, 10, 9]
    ...
    regions.append([3, 4, 7.*3600., 1e9, 200., 205, 19., 22.5])

    regions.append([5, 5, 7.*3600., 1e9, 202.0, 202.2, 21.15, 21.38]) 
    regions.append([6, 6, 7.5*3600., 1e9, 202.08,202.16,21.28,21.328])
    # Pearl Harbor:
    #regions.append([6, 6, 7.5*3600., 1e9, 202.0,202.068,21.3,21.388])
...
#-------------------
    ...
    topofiles.append([3, 1, 1, 0.0, 1e10, topodir+'oahu_1s.asc'])
    topofiles.append([3, 1, 1, 0.0, 1e10, topodir+'pearl.txt'])
