...
#------------------------------
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times =  np.linspace(7,13,7)*3600.
    ...
    gauges.append([1116, 203.04117, 21.0033, 25200.0, 1e10])
    gauges.append([1118, 203.30818, 21.00178, 25200.0, 1e10])
    gauges.append([1119, 203.25283, 20.86727, 25200.0, 1e10])
    gauges.append([1120, 203.31472, 20.86845, 25200.0, 1e10])
    gauges.append([1121, 203.49188, 20.61252, 27000.0, 1e10])
    gauges.append([1122, 203.50765, 20.76525, 25920.0, 1e10])
    ...
    # 2 degree, 24', 4', 1', 6"
    amrdata.refinement_ratios_x = [5, 6, 4, 10]
    amrdata.refinement_ratios_y = [5, 6, 4, 10]
    amrdata.refinement_ratios_t = [5, 6, 4, 10]
    ...
    regions.append([1, 2, 0.0, 1e10, 0, 360, -90, 90]) 
    regions.append([1, 3, 0.0, 18000.0, 132.0, 220.0, 5.0, 40.0])
    regions.append([1, 3, 18000.0, 28800.0, 180.0, 220.0, 5.0, 40.0])
    regions.append([4, 4, 0.0, 1800, 135, 150, 30, 45])
    regions.append([3, 4, 23400.0, 1e10, 200.0, 206, 18.0, 22.0])
    regions.append([4, 5, 25200.0, 1e10, 200, 204.5, 20.0, 21.6])
    regions.append([5, 5, 27000.0, 1e10, 202.6, 204.2, 20.4, 21.4])
